...
const Media = () => {
  ...
  const media = [
    {
      foto: "/photo_team/saddan.png",
      nama: "Saddan Syah Akbar",
      jurusan: "Information Technology 2020",
    },
    {
      foto: "/photo_team/ulfah.png",
      nama: "Ulfah Nur Azizah",
      ...
      <div className="w-screen bg-white h-full relative overflow-hidden z-[100]">
        ...
        <Image
          ...
          className={`right-4 rotate-90 top-[50%]  absolute z-40 hidden lg:block hover:cursor-pointer ${
            swiperIndex == media.length - 1 ? "opacity-50" : ""
          }`}
