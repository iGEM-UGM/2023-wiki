...
const Team = () => {
  ...
  return (
    <div className="scroll-smooth overflow-hidden">
      ...
      <Navbar />
      <ProgressBar height="3px" bgColor="#fca311" className="z-[200]" />
      <div
        ref={background.ref}
        style={{
      ...
      <div className="fixed flex flex-col justify-center items-center z-50 left-[50%] translate-x-[-50%] top-[50%] translate-y-[-50%] gap-y-12">
        ...
        <Image
          ...
          height={50}
          alt=""
          className="relative animate-bounce block mx-auto rotate-180 hover:cursor-pointer"
          onClick={() => {
      ...
      <div className="h-full w-screen relative bg-primary-200 text-white pt-24 px-12 z-[100]">
        ...
        />
        <p className="font-bubblegum font-bold text-6xl relative z-10">About</p>
      ...
      <svg
        ...
        className="fixed lg:bottom-[5%] lg:right-[2.5%] right-[1%] bottom-[1%] lg:scale-[200%] z-[101] lg:hover:scale-[210%] duration-300 scroll-smooth hover:cursor-pointer"
        onClick={() => {
